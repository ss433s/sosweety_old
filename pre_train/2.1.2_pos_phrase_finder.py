import json, os
# import pandas as pd
# from sParser import Word, Parse_result, stanford_simplify, phrase_patterns
...
# 外部调用awk做stat
# with open('./init_data/2.1.2_all_pos_phrases') as f:
#     tmp_file = './init_data/2.1.2_all_pos_phrases_simple'
...
tmp_file = './init_data/2.1.2_all_pos_phrases_simple'
# cmd = 'bash ./utils/stat.sh ' + tmp_file
# os.system(cmd)
